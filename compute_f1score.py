...
def main():
    ...
    recall_microsoft_dlm = pseudo_recall(referen_tokens, microsoft_dlm_tokens, entities)
    ...
    df["recall_microsoft_dlm"] = recall_microsoft_dlm[4]
    ...
    precision_microsoft_dlm = pseudo_precision(referen_tokens, microsoft_dlm_tokens, entities)
    ...
    df["precision_microsoft_dlm"] = precision_microsoft_dlm[4]
    ...
    f1_score_microsoft_dlm = f1_score(precision_microsoft_dlm[5], recall_microsoft_dlm[5])
    ...
    df = df.reindex(
        columns=[
            ...
            "precision_microsoft",
            "microsoft_dlm",
            "recall_microsoft_dlm",
            "precision_microsoft_dlm",
        ]
    )
